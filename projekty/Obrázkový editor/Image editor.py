...
control_col = sg.Column([
    [sg.Frame('Rozmazání',layout=[[sg.Slider(range = (0,10), orientation= 'h', key = '-BLUR-')]])],
    [sg.Frame('Kontrast',layout=[[sg.Slider(range = (0,10), orientation= 'h', key = '-CONTRAST-')]])],
    [sg.Checkbox('Emboss', key = '-EMBOSS-'), sg.Checkbox('Kresba', key =  '-CONTOUR-')],
    [sg.Checkbox('Otočit x', key = '-FLIPX-'), sg.Checkbox('Otočit y', key =  '-FLIPY-')],
    [sg.Button('Uložit obrázek', key = '-SAVE-')],
