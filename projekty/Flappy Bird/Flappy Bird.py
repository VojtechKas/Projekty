...
def draw_floor():
    screen.blit(floor_surface, (floor_x_pos, 840))
    screen.blit(floor_surface, (floor_x_pos + 576, 840))
...
def check_collision(pipes):
    ...
    if bird_rect.top <= -100 or bird_rect.bottom >= 840:
        can_score = True
        return False
...
def score_display(game_state):
    if game_state == 'main_game':
        ...
        score_rect = score_surface.get_rect(center = (288,165))
